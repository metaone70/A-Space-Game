...
IRQ2                   
                 LDX #$00
LOOP             DEC STARSDELAYARRAY,X          ; $104A,X 
                 BEQ OK                         ; L_BRS_($10A9)_($10A4) OK
                 JMP SKIPUPDATE                 ; L_JMP_($1138)_($10A6) OK

OK               LDA STARSSPEEDCOLARRAY,X       ; $1072,X 
                 STA STARSDELAYARRAY,X          ; $104A,X 
                 STX STARSCURRENTX              ; $109A 

                 LDA STARSYCHARARRAY,X          ; $0FFA,X 
                 STA STARSCURRENTY              ; $109B 
                 INC STARSFRAMEARRAY,X          ; $1022,X 
                 LDA STARSFRAMEARRAY,X          ; $1022,X 
                 CMP #94
                 BNE SKIP                       ; L_BRS_($10FC)_($10C0) OK

                 LDA #86
                 STA STARSFRAMEARRAY,X          ;$1022,X 

                 LDY STARSCURRENTY              ; $109B 
                 LDA SCREENRAMROWSTARTLOW,Y     ; $1161,Y 
                 STA $03 
                 LDA SCREENRAMROWSTARTHIGH,Y    ; $117A,Y 
                 STA $04
                 LDY STARSCURRENTX              ; $109A 

                 LDA #$20                       ; SPACECHARACTER
                 STA ($03),Y 

                 INC STARSYCHARARRAY,X          ; $0FFA,X 
                 LDA STARSYCHARARRAY,X          ; $0FFA,X 
                 CMP #$19
                 BNE SKIP                       ; L_BRS_($10FC)_($10E3) OK

                 LDA #$01
                 STA STARSYCHARARRAY,X          ; $0FFA,X 

                 INC STARSNEXTSPEED             ; $109E 
                 LDA STARSNEXTSPEED             ; $109E 
                 STA STARSSPEEDCOLARRAY,X       ; $1072,X 
                 CMP #$04
                 BNE SKIP                       ; L_BRS_($10FC)_($10F5) OK
                 LDA #$01
                 STA STARSNEXTSPEED             ; $109E 

SKIP             LDA STARSYCHARARRAY,X          ; $0FFA,X  SET THE CURRENT Y CHAR
                 STA STARSCURRENTY              ; $109B 
                 LDA STARSFRAMEARRAY,X          ; $1022,X  SET THE CURRENT FRAME
                 STA STARSCURRENTFRAME          ; $109C 
                 LDA STARSSPEEDCOLARRAY,X       ; $1072,X SET THE CURRENT COLOR
                 STA STARSCURRENTCOLOR          ; $109D 

                 LDY STARSCURRENTY 
                 LDA COLORRAMROWSTARTLOW,Y      ; $1193,Y 
                 STA $03 
                 LDA COLORRAMROWSTARTHIGH,Y     ;$11AC,Y 
                 STA $04 
                 LDY STARSCURRENTX              ; $109A 
                 LDA STARSCURRENTCOLOR          ; $109D 
                 STA ($03),Y 
                 ...
                 STA $04 
                 LDY STARSCURRENTX              ; $109A 
                 LDA STARSCURRENTFRAME          ; $109C 
                 STA ($03),Y 

SKIPUPDATE       INX 
                 CPX #$28
                 BEQ FINISHED                   ; L_BRS_($1140)_($113B) OK
                 JMP LOOP                       ; L_JMP_($10A1)_($113D) OK
...
COLLIDED
          ...
          JSR WRITESCORE        ; GOTO WRITE SUBROUTINE
          ...
          LDA ENSHIPDIR         ; CHANGE ENEMYSHIP DIRECTION
          EOR #$01
          STA ENSHIPDIR
...
SCREEN5 = $07C3         ; YOU ARE DOWN MESSAGE SCREEN LOCATION
SCREEN6 = $07C5         ; ENEMY SHIP DOWN MESSAGE SCREEN LOCATION
SCREEN5COL = $DBC3      ; YOU ARE DOWN MESSAGE COLOR LOCATION
SCREEN6COL = $DBC5      ; ENEMY SHIP DOWN MESSAGE COLOR LOCATION
...
; SCREEN 2 -  ARENA SCREEN DATA
*=$5000 
        BYTE    $20,$08,$09,$2D,$13,$03,$0F,$12,$05,$3A,$30,$30,$30,$30,$20,$20,$20,$0C,$09,$16,$05,$13,$3A,$33,$20,$20,$20,$13,$03,$0F,$12,$05,$3A,$30,$30,$30,$30,$20,$20,$20
        BYTE    $20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20,$20
...
; SCREEN 2 -  ARENA SCREEN COLOR
*=$5400
        BYTE    $0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$01,$01,$01,$01,$01,$01,$01,$01,$00,$0F,$0D,$05,$05,$05,$05,$05,$05,$05,$05,$05,$05,$0D,$01,$01
