...
setupsprıtes
        ...
        ; set sprıte poınters
        lda #$39        ; maın shıp --> $2800 -> $5000
        sta $07F8
        lda #$3a        ; enemy shıp
        sta $07F9
        lda #$3b        ; maın shıp bullet
        sta $07FA
        lda #$3c        ; enemy shıp bullet
        sta $07FB       
        lda #$3d        ; explosıon
        sta $07FC        
...
drawscreen
                ...
                lda #$10        ; $2800 character data -->  transfer to $0400
                sta $fc

                lda #$04
                sta $fe

                lda #$00        ; $2be8 screen color data --> transfer to $d800
                sta $f9
                lda #$20
                sta $fa
...
collısıoncheck
          ...
          beq collıded
          cmp #%000001001       ; check ıf enemy shıp bullet and maın shıp collıded
          beq collıded2
          rts
...
colloop   lda #$3d        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
          
          lda #$3e        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol

          lda #$3f        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
...
screen3col = $d9eb
screen4col = $da35
SND = 54272 ; $d400 Voıce 1 freq low byte
SB  = 54296 ; $d418 filter mode and volume
...
>>>>>>> b3d3fcafd5513f2e9055b8a2d0675fca6c01ab81
