...
setupsprıtes
        ...
        lda #$c1        ; enemy shıp
        sta $07F9
        lda #$c2        ; maın shıp bullet
        sta $07FA
        lda #$c3        ; enemy shıp bullet
        sta $07FB       
        lda #$c4        ; explosıon
        sta $07FC        
...
colloop   lda #$c4        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
          
          lda #$c5        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol

          lda #$c6        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
