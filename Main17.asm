...
setupsprıtes
        ...
        lda #$a1        ; enemy shıp
        sta $07F9
        lda #$a2        ; maın shıp bullet
        sta $07FA
        lda #$a3        ; enemy shıp bullet
        sta $07FB       
        lda #$a4        ; explosıon
        sta $07FC        
...
drawscreen
                ...
                lda #$50        ; $2800 character data -->  transfer to $0400
                sta $fc
...
colloop   lda #$a4        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
          
          lda #$a5        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol

          lda #$a6        ; sprıte 4's poınter
          sta $07FC       ;
          jsr drawcol
