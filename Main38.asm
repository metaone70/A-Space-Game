...
MISSILE
                ...
                LDA #01
                STA MISSILEON           ; NOW THERE IS A MISSILE ON SCREEN
...
MOVEMISSILE     LDY SPRITEPOS+$0F
                ...
                LDA #00
                STA MISSILEXNO
LOADMISSX       LDX MISSILEXNO          ; WE ARE PUTTING A NEW MISSILE ON SCREEN
                LDA MISSILEX,X          ; THE NEXT ROW IS TRANSFERED TO X POSITION
                STA SPRITEPOS+$0E     
                JSR MISSILEBEEP
FINMISSILE      RTS
...
MISSILETIME     BYTE 00
MISSILEON       BYTE 00
MISSILEX        BYTE 30,60,90,120,150
MISSILEY        BYTE 60        
MISSILEXNO      BYTE 00
