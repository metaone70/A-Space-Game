...
MISSILETIME     BYTE 00                         ; 0=IT'S NOT THE TIME FOR THE MISSILE YET :)
MISSILEON       BYTE 00                         ; 0=NO MISSILE DURING GAMEPLAY
MISSILEX        BYTE 30,60,90,120,150           ; X XOORDINATES FOR THE MISSILE TO DROP DOWN
MISSILEY        BYTE 60                         ; MISSILE Y COORDINATE TO START
MISSILEXNO      BYTE 00                         ; THE NUMPER POINTER TO THE X COORDINATE TABLE
