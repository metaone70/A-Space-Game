...
CLEANCOLOR       DEX 
                 ...
                 LDX #$00
TEXTLOOP         
                 LDA ARENATEXT,X        ; WRITES THE TOPMOST LINE
...
CDIRUP
          INC ENEMY2DIR         ; INCREMENT VARIABLE, SO THE DIRECTION IS UP
          JMP FINENEMY2
...
CDIRDOWN
          DEC ENEMY2DIR         ; DECREMENT VARIABLE, SO THE DIRECTION IS DOWN
          JMP FINENEMY2          

FINENEMY2
          STX SPRITEPOS+$09     ; FINALIZE THE POSITION OF THE ENEMY SHIP 2
          RTS
...
INPUT   
        JSR COLORANIM1          ; TEXT COLOR ANIMATIN OF THE 1ST LINE
...
YOUAREHITCLEAR                  ; AFTER KEYBOARD RESPONSE, CLEAR THE LINE
        LDX #00
MSH2    LDA #32
        STA SCREEN5,X
        INX
...
ENEMYHITCLEAR                   ; AFTER KEYBOARD RESPONSE, CLEAR THE LINE
        LDX #00
ESH2    LDA #32
        STA SCREEN6,X
        INX
...
YES               
            LDA SCORE        ; LOAD THE NEW SCORE VALUES TO HIGHSCORE 
            STA HISCORE    
            LDA SCORE+1
            STA HISCORE+1
            RTS    
